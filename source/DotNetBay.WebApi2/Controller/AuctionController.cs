...
namespace DotNetBay.WebApi.Controller
{
    public class AuctionController : ApiController
    {
        ...
        public IHttpActionResult PostNewAuction([FromBody] AuctionDto dto)
        {
        ...
        public HttpResponseMessage GetImageForAuction(long id)
        {
            var auction = this.auctionService.GetAll().FirstOrDefault(a => a.Id == id);
        ...
        [Route("api/Auction/{id}/image")]
        public async Task<IHttpActionResult> PostAddImageForAuction(long id)
        {
            var auction = this.auctionService.GetAll().FirstOrDefault(a => a.Id == id);
